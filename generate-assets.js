...
// Generate 600x600 pajuog.png (Cherry Soft Warm Red/Gold Gradient)
const pajuOgBuf = createPngBuffer(600, 600, 230, 40, 80);
...
fs.writeFileSync('./pajuog.png', pajuOgBuf);
fs.writeFileSync('./public/pajuog.png', pajuOgBuf);

fs.writeFileSync('./og-image.png', ogBuf);
fs.writeFileSync('./public/og-image.png', ogBuf);

console.log('Successfully generated cherrylogo.png, pajuog.png, favicon.png and og-image.png in root and public!');
